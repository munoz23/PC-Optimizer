...
class PowerShell:
    ...
    @staticmethod
    def execute_commands_powershell(command:str):
        return subprocess.run(['powershell',command],stdout=subprocess.PIPE,stderr=subprocess.PIPE,shell=True,capture_output=False,universal_newlines=True)                  
